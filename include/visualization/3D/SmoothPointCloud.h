...
namespace gdr {
    ...
    struct SmoothPointCloud {
        ...
        static int registerPointCloudFromImages(const std::vector<VertexPose> &posesToBeRegistered,
        ...
        static std::vector<PointXYZRGBfloatUchar> getPointCloudXYZRGBFromPose(const VertexPose &poseToBeRegistered);
    };
}
