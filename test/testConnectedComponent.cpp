...
TEST(testConnectedComponent, posesVisualizationPlant) {

    for (int iterations = 0; iterations < 1; ++iterations) {
        int numberOfPosesInDataset = 101;
...
//                                                     516.5, 255.3);
        ...
        correspondenceGraph.bfsDrawToFile("../../tools/data/temp/" + shortDatasetName + "connectedComponents_" + numberOfPosesString + ".dot");
...

        {
            ...
            std::string outputName = "../../tools/data/temp/" + shortDatasetName + "posesBiggestComponent_GT_" + numberOfPosesString + ".txt";
...

        {
            ...
            std::string outputName = "../../tools/data/temp/" + shortDatasetName + "posesBiggestComponent_IRLS_" + numberOfPosesString + ".txt";
            std::ofstream computedPoses(outputName);
            for (int i = 0; i < posesInfo.size(); ++i) {
        ...
        }
        {
            ...
            std::string outputName = "../../tools/data/temp/" + shortDatasetName + "posesBiggestComponent_BA_" + numberOfPosesString + ".txt";
            std::ofstream computedPoses(outputName);
            for (int i = 0; i < posesInfo.size(); ++i) {
...
//                                                     516.5, 255.3);
        ...
        {
            // print ground truth poses to file
            std::string outputName = "../../tools/data/temp/posesBiggestComponent_GT_" + numberOfPosesString + ".txt";
            std::ofstream computedPoses(outputName);
            for (int i = 0; i < posesInfo.size(); ++i) {
                Sophus::SE3d poseSE3 = posesInfo[i].getSophusPose();
        ...
        {
            // print poses IRLS to file
            std::string outputName = "../../tools/data/temp/posesBiggestComponent_IRLS_" + numberOfPosesString + ".txt";
            std::ofstream computedPoses(outputName);
            for (int i = 0; i < posesInfo.size(); ++i) {
                Sophus::SE3d poseSE3 = posesInfo[0].getSophusPose() * posesIRLS[i];
        ...
        {
            // print poses BA depth to file
            std::string outputName = "../../tools/data/temp/posesBiggestComponent_BA_" + numberOfPosesString + ".txt";
            std::ofstream computedPoses(outputName);
            for (int i = 0; i < posesInfo.size(); ++i) {
                Sophus::SE3d poseSE3 = posesInfo[0].getSophusPose() * bundleAdjustedPoses[i];
